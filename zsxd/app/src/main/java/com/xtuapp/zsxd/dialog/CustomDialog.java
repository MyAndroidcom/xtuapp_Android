...
public class CustomDialog extends Dialog {
    ...
    private Button PositvButton;
    @ViewInject(R.id.negativeButton)
    private Button NegatvButton;
...
//            ((TextView) layout.findViewById(R.id.title)).setText(title);
            ...
            if (message != null) {
                ...
                ((LinearLayout) layout.findViewById(R.id.content))
                        .removeAllViews();
                ((LinearLayout) layout.findViewById(R.id.content))
                        .addView(contentView, new LayoutParams(LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT));
            }
